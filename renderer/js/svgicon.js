...
const PATHS = {
  ...
  'rotate-ccw': ['M2.65 5.2v5.1h5.1', 'M4.72 14.55a7.65 7.65 0 1 0 1.81-7.96L2.65 10.3'],
  'skip-back': ['M18.5 19.5L9 12l9.5-7.5z', 'M5.5 5v14'],
  'skip-forward': ['M5.5 4.5L15 12l-9.5 7.5z', 'M18.5 5v14'],
